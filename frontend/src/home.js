...
console.log("results- ",results.length)
  ...
  componentDidUpdate=()=>{
    ...
    this.getDataFromDb();
    const loggedUser=localStorage.getItem('starName')
  }
    ...
    return (
      <div className="main">
        ...
        <div className="Jumbotron box text-center">
          <h2 className="display-4">Welcome to Star BUS</h2>
          <hr />
          ...
          <div className="form-group">
           ...
           {this.state.next ==1 ? <Display results={results} />       
            // <Redirect to= {{ pathname: '/dynamic', state: { results: [...results]}} }/>
           :null}
        </div> 
       );
  }
